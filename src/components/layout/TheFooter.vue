  ...
  <footer class="bg-gray-100 py-8 mt-auto">
    <div class="container mx-auto px-4">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          <h3 class="font-bold mb-4">Jewelry Shop</h3>
          <p class="text-sm text-gray-600">
            Exquisite handcrafted jewelry for every occasion. Quality materials, timeless designs.
          </p>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li><RouterLink to="/products" class="text-sm hover:underline">All Products</RouterLink></li>
            <li><RouterLink to="/products?category=rings" class="text-sm hover:underline">Rings</RouterLink></li>
            <li><RouterLink to="/products?category=necklaces" class="text-sm hover:underline">Necklaces</RouterLink></li>
            <li><RouterLink to="/products?category=bracelets" class="text-sm hover:underline">Bracelets</RouterLink></li>
            <li><RouterLink to="/products?category=earrings" class="text-sm hover:underline">Earrings</RouterLink></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li><a href="#" class="text-sm hover:underline">Shipping Policy</a></li>
            <li><a href="#" class="text-sm hover:underline">Returns & Exchanges</a></li>
